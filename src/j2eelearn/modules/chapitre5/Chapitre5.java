...
public class Chapitre5 implements ChapitreEvent{
    ...
    private ChapitreContents content = Chapitre5Contents.getInstance();
    
    public Chapitre5 (String chap,JPanel north, JPanel south) {
    	//TDO:
    }
    @Override
