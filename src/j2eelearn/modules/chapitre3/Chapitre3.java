...
public class Chapitre3 implements ChapitreEvent{
    ...
    private ChapitreContents content = Chapitre3Contents.getInstance();
    
    public Chapitre3 (String chap,JPanel north, JPanel south) {
    	//TDO:
    }
    @Override
