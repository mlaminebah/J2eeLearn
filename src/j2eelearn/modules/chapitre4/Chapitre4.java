...
public class Chapitre4 implements ChapitreEvent{
    ...
    private ChapitreContents content = Chapitre4Contents.getInstance();
    
    public Chapitre4 (String chap,JPanel north, JPanel south) {
    	//TDO:
    }
    @Override
