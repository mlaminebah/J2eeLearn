...
public class Chapitre6 implements ChapitreEvent{
    ...
    private ChapitreContents content = Chapitre6Contents.getInstance();
    
    public Chapitre6 (String chap,JPanel north, JPanel south) {
    	//TDO:
    }
    @Override
